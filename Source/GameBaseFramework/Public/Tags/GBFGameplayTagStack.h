...
struct GASEXTENSIONS_API FGBFGameplayTagStack : public FFastArraySerializerItem
{
    GENERATED_BODY()
...
USTRUCT( BlueprintType )
struct GASEXTENSIONS_API FGBFGameplayTagStackContainer : public FFastArraySerializer
{
    GENERATED_BODY()
