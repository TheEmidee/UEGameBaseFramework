...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams( FGBFOnMonitorTriggerManagerDelegate, AActor *, activator, int, actor_count );
...
protected:
    ...
    FGBFOnMonitorTriggerManagerDelegate OnTriggerActivatedDelegate;

    UPROPERTY( BlueprintAssignable )
    FGBFOnMonitorTriggerManagerDelegate OnActorInsideTriggerCountChangedDelegate;
