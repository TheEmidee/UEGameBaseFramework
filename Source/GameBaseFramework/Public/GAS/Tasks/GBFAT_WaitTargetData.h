...
#include "GBFAT_WaitTargetData.generated.h"
...
struct GAMEBASEFRAMEWORK_API FGBFWaitTargetDataReplicationOptions
{
    GENERATED_USTRUCT_BODY()

    FGBFWaitTargetDataReplicationOptions();
...
UCLASS( Abstract )
class GAMEBASEFRAMEWORK_API UGBFAT_WaitTargetData : public UAbilityTask
{
    GENERATED_BODY()

public:
    UGBFAT_WaitTargetData();
...
protected:
    ...
    FGBFWaitTargetDataReplicationOptions ReplicationOptions;
