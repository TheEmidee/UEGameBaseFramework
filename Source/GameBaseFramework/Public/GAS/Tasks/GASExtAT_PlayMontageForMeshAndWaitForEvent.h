...
#include "GASExtAT_PlayMontageForMeshAndWaitForEvent.generated.h"
...
UCLASS()
class GAMEBASEFRAMEWORK_API UGASExtAT_PlayMontageForMeshAndWaitForEvent final : public UAbilityTask
{
    GENERATED_BODY()

public:
    UGASExtAT_PlayMontageForMeshAndWaitForEvent();
    ...
    static UGASExtAT_PlayMontageForMeshAndWaitForEvent * PlayMontageForMeshAndWaitForEvent(
...
private:
    ...
    UGASExtAbilitySystemComponent * GetTargetASC() const;
