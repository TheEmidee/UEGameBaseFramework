...
#include "GBFAT_WaitInputRelease.generated.h"

UCLASS()
class GAMEBASEFRAMEWORK_API UGBFAT_WaitInputRelease final : public UAbilityTask_WaitInputRelease
{
    GENERATED_BODY()
...
public:
    ...
    static UGBFAT_WaitInputRelease * SWWaitInputRelease( UGameplayAbility * owning_ability, bool it_tests_already_released = false );
};
