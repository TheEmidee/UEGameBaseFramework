...
#include "GBFAbilitySystemFunctionLibrary.generated.h"
...
UCLASS()
class GAMEBASEFRAMEWORK_API UGBFAbilitySystemFunctionLibrary final : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
