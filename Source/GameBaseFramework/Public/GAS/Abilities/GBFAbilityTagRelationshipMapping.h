...
#include "GBFAbilityTagRelationshipMapping.generated.h"

// Straight import from Lyra

USTRUCT()
struct FGBFAbilityTagRelationship
{
    GENERATED_BODY()
...
UCLASS()
class GAMEBASEFRAMEWORK_API UGBFAbilityTagRelationshipMapping final : public UDataAsset
{
    GENERATED_BODY()
...
private:
    ...
    TArray< FGBFAbilityTagRelationship > AbilityTagRelationships;
};
