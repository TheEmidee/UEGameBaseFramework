...
#include "GASExtAbilityTagRelationshipMapping.generated.h"

// Straight import from Lyra

USTRUCT()
struct FGASExtAbilityTagRelationship
{
    GENERATED_BODY()
...
UCLASS()
class GAMEBASEFRAMEWORK_API UGASExtAbilityTagRelationshipMapping final : public UDataAsset
{
    GENERATED_BODY()
...
private:
    ...
    TArray< FGASExtAbilityTagRelationship > AbilityTagRelationships;
};
