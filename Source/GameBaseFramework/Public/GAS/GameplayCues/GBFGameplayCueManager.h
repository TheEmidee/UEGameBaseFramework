...
#include "GBFGameplayCueManager.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams( FGBFOnGameplayCueRoutedDelegate, AActor *, target_actor, FGameplayTag, gameplay_tag, EGameplayCueEvent::Type, event_type, const FGameplayCueParameters &, params );

UCLASS()
class GAMEBASEFRAMEWORK_API UGBFGameplayCueManager : public UGameplayCueManager
{
    GENERATED_BODY()

public:
    FGBFOnGameplayCueRoutedDelegate & OnGameplayCueRouted();
    ...
    static UGBFGameplayCueManager * Get();
...
private:
    ...
    FGBFOnGameplayCueRoutedDelegate OnGameplayCueRoutedDelegate;
};

FORCEINLINE FGBFOnGameplayCueRoutedDelegate & UGBFGameplayCueManager::OnGameplayCueRouted()
{
