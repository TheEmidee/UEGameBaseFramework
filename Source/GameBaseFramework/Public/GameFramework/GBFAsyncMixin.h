...
private:
    ...
    {
    public:
        FLoadingState( FGBFAsyncMixin & InOwner );
...
private:
    static TMap< FGBFAsyncMixin *, TSharedRef< FLoadingState > > Loading;
};
 ...
 */
class GAMEBASEFRAMEWORK_API FAsyncScope : public FGBFAsyncMixin
{
public:
