...
public:
    ...
    void GetAllGameFeatures( TArray< FString > & out_game_features, const FString & url ) const;
    void GetAllActions( TArray< UGameFeatureAction * > & out_actions, const FString & url ) const;
