...
UGBFSettingValueDiscrete_Resolution::UGBFSettingValueDiscrete_Resolution()
{
}

void UGBFSettingValueDiscrete_Resolution::OnInitialized()
{
    Super::OnInitialized();
...
void UGBFSettingValueDiscrete_Resolution::StoreInitial()
{
    // Ignored
}

void UGBFSettingValueDiscrete_Resolution::ResetToDefault()
{
    // Ignored
}

void UGBFSettingValueDiscrete_Resolution::RestoreToInitial()
{
    // Ignored
}

void UGBFSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex( int32 Index )
{
...
int32 UGBFSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray< FText > UGBFSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UGBFSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UGBFSettingValueDiscrete_Resolution::InitializeResolutions()
{
    Resolutions.Empty();
...
void UGBFSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UGBFSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution( const FScreenResolutionRHI & SrcScreenRes, int32 FilterThreshold ) const
{
...
int32 UGBFSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution( const FIntPoint & InPoint ) const
{
...
int32 UGBFSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid( const FIntPoint & InPoint ) const
{
...
int32 UGBFSettingValueDiscrete_Resolution::FindClosestResolutionIndex( const FIntPoint & Resolution ) const
{
    int32 Index = 0;
...
void UGBFSettingValueDiscrete_Resolution::GetStandardWindowResolutions( const FIntPoint & MinResolution, const FIntPoint & MaxResolution, float MinAspectRatio, TArray< FIntPoint > & OutResolutions )
{
...
FText UGBFSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
