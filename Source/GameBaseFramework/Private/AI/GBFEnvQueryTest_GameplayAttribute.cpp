#include "AI/GBFEnvQueryTest_GameplayAttribute.h"

#include <AbilitySystemBlueprintLibrary.h>
#include <EnvironmentQuery/Items/EnvQueryItemType_ActorBase.h>

UGBFEnvQueryTest_GameplayAttribute::UGBFEnvQueryTest_GameplayAttribute( const FObjectInitializer & object_initializer )
{
...
void UGBFEnvQueryTest_GameplayAttribute::RunTest( FEnvQueryInstance & query_instance ) const
{
...
FText UGBFEnvQueryTest_GameplayAttribute::GetDescriptionDetails() const
{
    return FText::FromString( Attribute.GetName() );
}

FText UGBFEnvQueryTest_GameplayAttribute::GetDescriptionTitle() const
{
