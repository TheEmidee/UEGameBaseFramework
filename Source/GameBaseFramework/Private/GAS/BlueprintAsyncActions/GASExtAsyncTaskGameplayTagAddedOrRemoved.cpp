#include "GAS/BlueprintAsyncActions/GASExtAsyncTaskGameplayTagAddedOrRemoved.h"

#include <AbilitySystemComponent.h>

UGASExtAsyncTaskGameplayTagAddedOrRemoved * UGASExtAsyncTaskGameplayTagAddedOrRemoved::ListenForGameplayTagAddedOrRemoved( UAbilitySystemComponent * ability_system_component, const FGameplayTag gameplay_tag, bool only_trigger_once /*= false*/, bool broadcast_event_on_activation /*= true*/ )
{
    auto wait_for_gameplay_tag_changed_task = NewObject< UGASExtAsyncTaskGameplayTagAddedOrRemoved >();
...
void UGASExtAsyncTaskGameplayTagAddedOrRemoved::EndTask()
{
    if ( IsValid( ASC ) )
    {
...
void UGASExtAsyncTaskGameplayTagAddedOrRemoved::GameplayTagChanged( const FGameplayTag tag, int32 tag_event_type )
{
