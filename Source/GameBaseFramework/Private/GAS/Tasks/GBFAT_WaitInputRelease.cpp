#include "GAS/Tasks/GBFAT_WaitInputRelease.h"

#include <AbilitySystemComponent.h>
#include <Engine/World.h>

void UGBFAT_WaitInputRelease::Activate()
{
...
UGBFAT_WaitInputRelease * UGBFAT_WaitInputRelease::SWWaitInputRelease( UGameplayAbility * owning_ability, const bool it_tests_already_released )
{
    auto * task = NewAbilityTask< UGBFAT_WaitInputRelease >( owning_ability );
